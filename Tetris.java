            ...
            if(!paused){
                ...
                if(!dejavu){
                    ...
                    if(!nextTetrad.translate(1,0)){
                        ...
                        nextTetrad.translate(0, ((Math.random()<0.5) ? ((int)(Math.random()*4)) :(-1*(int)(Math.random()*4))));
                        DisplayNextTetrad();
                        controlsActive = true;
                        meteors++;
                        if(meteors%10==0){
    ...
    public void dPressed(){
        if(cheats){
            ...
            if(dejavu){
                ...
                activeTetrad.SpawnTetrad();
                nextTetrad.SpawnTetrad();
                nextTetrad.translate(0, ((Math.random()<0.5) ? ((int)(Math.random()*3)) :(-1*(int)(Math.random()*4))));
            }else{
                nextTetrad = new Tetrad(grid);
                activeTetrad = new Tetrad(grid);
                activeTetrad.SpawnTetrad();
